...
from nnunet.utilities.file_ops import abs_path, gfd, gfn, join_path
from typing import Tuple, Union, List

import numpy as np
from batchgenerators.augmentations.utils import resize_segmentation
from nnunet.inference.segmentation_export import save_segmentation_nifti_from_softmax, save_segmentation_nifti, save_segmentation_softmax
...
from nnunet.utilities.file_ops import gfn
...
def predict_cases(model, list_of_lists, output_filenames, folds, save_npz, num_threads_preprocessing,
    ...
    for preprocessed in preprocessing:
        ...
        if save_softmax:
            softmax_filename = join_path(gfd(output_filename), gfn(output_filename, no_extension=True) + '.nii.gz')
            results.append(
                pool.starmap_async(
                    save_segmentation_softmax,
                    (
                        (softmax,  softmax_filename, dct, interpolation_order, region_class_order,
...
def predict_from_folder(model: str, input_folder: str, output_folder: str, folds: Union[Tuple[int], List[int]],
                        ...
                        segmentation_export_kwargs: dict = None, disable_postprocessing: bool = False,
                        save_softmax: bool=False, selected_cases: Union[list, None] = None):
    """
